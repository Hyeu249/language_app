...
class AnswerButton extends Component {
    ...
    async actionSetIsCompleted(isCompleted = false) {
        try {
            await this.orm.call(this.model_name, "set_is_completed", [this.res_id, isCompleted], {})
...
class ContinueButton extends Component {
    ...
    async actionContinueVocabulary() {
        try {
            const action = await this.orm.call(this.model_name, "continue_vocabulary", [this.res_id], {})
            await this.props.record.model.root.load()
            await this.props.record.model.notify()
        } catch (error) {
